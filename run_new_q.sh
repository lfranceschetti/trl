...
#SBATCH --output=run_new_q.out
#SBATCH --error=run_new_q.err
...
MODEL_ID="${MODEL_NAME:-unsloth/Meta-Llama-3.1-8B-Instruct-bnb-4bit}"
...
# FlashInfer JIT fix: CUDA 12.2 nvcc requires GCC ≤12 as host compiler.
# The cluster default (GCC 13.2) causes "unsupported GNU version" errors.
module load stack/2025-06
module load gcc/12.2.0
export CUDAHOSTCXX=$(which gcc)
rm -rf ~/.cache/flashinfer
rm -rf /cluster/home/fraluca/negotio2/trl/unsloth_compiled_cache
